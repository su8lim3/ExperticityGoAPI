...
func main() {
  ...
  frisby.Create("Test GET TEAMS BY ID").
        Get("http://uni.cd01.test:25551/xapi/team/int/1.0/teams/14").
        SetHeader("xapi-origin", "internal").
        Send().
        ExpectStatus(200).
        ExpectContent("3point5comemployees")
  })
